...
async def mentionall(client, message):
    ...
    if message.reply_to_message and message.text:
         return await message.reply("/tagall  ᴛʏᴘᴇ ʟɪᴋᴇ ᴛʜɪꜱ / ʀᴇᴘʟʏ ᴀɴʏ ᴍᴇꜱꜱᴀɢᴇ ɴᴇxᴛ ᴛɪᴍᴇ ")
    elif message.text:
        mode = "text_on_cmd"
        msg = message.text
...
async def cancel_spam(client, message):
    if not message.chat.id in spam_chats:
        return await message.reply("ᴄᴜʀʀᴇɴᴛɪʏ ɪ'ᴍ ɴᴏᴛ ..")
    is_admin = False
    try:
        ...
        if participant.status in (
            ...
            is_admin = True
    if not is_admin:
        return await message.reply("ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴀᴅᴍɪɴ ʙᴀʙʏ , ᴏɴʟʏ ᴀᴅᴍɪɴꜱ ᴄᴀɴ ᴛᴀɢ ᴍᴇᴍʙᴇʀ.")
    else:
        try:
